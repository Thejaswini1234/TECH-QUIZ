...
const Sidebar = () => {
  ...
  };//when the time is up the quiz will be automatically be submitted
  ...
  //when we change the tech it will update the local 
  ...
  };//that is that tech is done or not
...
//to submit data to DB
  ...
  const getQuestionStatus = (index) => {
    ...
    return "incorrect";
  };//it will show you the ques that is correct,wrong or unattempted
