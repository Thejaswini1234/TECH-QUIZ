...
import { Show,SignInButton,useAuth, UserButton, useUser} from '@clerk/react';
  ...
  useEffect(() => {
    ...
    useEffect(()=>{
        ...
        async function saveTokenAndMaybeRedirect(){
            ...
            path === "/" || path === "/login" || path === "/signed" || path === "";
            ...
            <div className={navbarStyles.innerContainer}>
                <div className={navbarStyles.homeButton}>
                  ...
                  <div className={navbarStyles.siteNameWrapper}>
                    ...
                    <span className={navbarStyles.siteSubtitle}>Learning Platform
                    </span>
                  </div>
                </button>
                </div>
