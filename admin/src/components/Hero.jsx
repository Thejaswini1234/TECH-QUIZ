...
const Hero = () => {
  ...
  return (
<>
<div className=' h-screen pb-30 w-screen overflow-hidden font-[pacifico] bg-gray-50 
flex items-center justify-center'>
    <div className='text-center px-6'>
        <div className='relative inline-flex mb-6'>
            <div className=" absolute inset-0 rounded-full bg-linear-to-r from-indigo-500
            via-purple-500 to-pink-500 animate-spin-slow blur-[2px]"
            />{" "}
