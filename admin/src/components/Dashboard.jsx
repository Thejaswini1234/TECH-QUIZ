...
const Dashboard = () => {
  ...
  }; // This function will open the CSV file and show qns,ans,options
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      resetForm(); // Back to initial value for each field
    } catch (err) {
  ...
  // Back to initial value for each field
  const resetForm = () => {
    setTechnology("");
    setLevel("Basic");
    setTimeLimit(30);
        ...
        <div className={dashboardStyles.grid}>
                        ...
                        <div className={dashboardStyles.previewContent}>
                              ...
                              return (
                                ...
                                >
                                  <div className="flex items-center gap-3">
                                    ...
                                    >
                                      {opt || (
                                        <span className={dashboardStyles.optionEmptyText}>
                                          Empty option
                                        </span>
                                      )}
                                    </span>
                                    {isCorrect && (
                                      <div className={dashboardStyles.correctIcon}>
                                        <CheckCircle className={dashboardStyles.correctIconSvg} />
                                      </div>
                                    )}
                                  </div>
                                </div>
                          ...
                          <div className={dashboardStyles.optionFooter}>
                            <div className={dashboardStyles.answerBadge}>
                              <CheckCircle className={dashboardStyles.answerBadgeIcon} />
          ...
          <div className={dashboardStyles.rightColumn}>
            ...
            <div className={dashboardStyles.summaryCard}>
              <h3 className={dashboardStyles.summaryTitle}>👥 Platform Stats</h3>
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  <span className={dashboardStyles.summaryLabel}>Login Rate</span>
                  <div className="flex items-center gap-2">
            ...
            <div className={dashboardStyles.summaryCard}>
              ...
              <div className={dashboardStyles.summaryRows}>
                ...
                <div className={dashboardStyles.summaryRow}>
                  <span className={dashboardStyles.summaryLabel}>Total Questions:</span>
                  <span className={dashboardStyles.summaryValue}>
                    {questions.length}
                  </span>
                </div>
      ...
      {toast.show && (
        <div
          className={`${dashboardStyles.toastOuter} ${
            toast.show ? dashboardStyles.toastVisible : dashboardStyles.toastHidden
          }`}
        >
          <div
