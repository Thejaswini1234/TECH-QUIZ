      ...
      <div className=' min-h-screen font-mono flex items-center justify-center bg-linear-to-b from-purple-50 via-white to-purple-100 px-4'>
        <div className='text-center'>
          ...
          <div className='flex justify-center'>
            <Link to='/' state={{from:location}}className='px-4 py-2 text-sm rounded-full
            bg-purple-600 text-white shadow-sm hover:bg-purple-700 hover:shadow-md transition-all duration-300 ease-in-out animate-pulse'>
              HOME
            </Link>
          </div>
        </div>
